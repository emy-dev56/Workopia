<x-layout>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="/jobs" enctype="multipart/form-data">
            ...
            <x-inputs.select id="job_type" name="job_type" label="Job Type" value="Full-Time" :options="['Full-Time' => 'Full-Time', 'Part-Time' => 'Part-time', 'Contract' => 'Contract', 'Temporary' => 'Temporary', 'Internship' => 'Internship', 'Volunteer' => 'Volunteer', 'On-Call' => 'On-Call']" />
            <x-inputs.select id="remote" name="remote" label="Remote" value="false" :options="[0 => 'No', 1 => 'Yes']" />
