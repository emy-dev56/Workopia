<x-layout>
    <div class="bg-white mx-auto p-8 rounded-lg shadow-md w-full md:max-w-3xl">
        ...
        <form method="POST" action="{{ route('jobs.update', $job->id) }}" enctype="multipart/form-data">
            ...
            <x-inputs.text id="salary" name="salary" label="Annual Salary" placeholder="90000" type="number" :value="old('salary', $job->salary)" />
            ...
            <x-inputs.text id="company_website" name="company_website" label="Company Website" placeholder="Enter website" type="url" :value="old('comapny_website', $job->company_website)" />
